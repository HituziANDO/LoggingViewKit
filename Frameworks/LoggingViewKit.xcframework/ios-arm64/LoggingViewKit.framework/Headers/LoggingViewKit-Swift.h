...
#ifndef LOGGINGVIEWKIT_SWIFT_H
#define LOGGINGVIEWKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="LoggingViewKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS_NAMED("LVKCounter")
@interface LVKCounter : NSObject
...
///
- (nonnull instancetype) initWithName:(NSString * _Nonnull)name database:(id <LGVDatabase> _Nonnull)db;
/// Initializes using arguments.
/// \param name The name of the counter.
///
/// \param count The value of the counter.
///
/// \param createdAt The date that is started to use the counter.
///
/// \param updatedAt The date that the counter was updated at.
///
/// \param db The database.
///
...
/// The log viewer.
SWIFT_CLASS_NAMED("LVKLogViewController")
@interface LVKLogViewController : UIViewController
- (nullable instancetype) initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
- (void) viewDidLoad;
- (nonnull instancetype) initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil SWIFT_UNAVAILABLE;
@end

@class LGVFileDestination;

@interface LVKLogViewController (SWIFT_EXTENSION (LoggingViewKit))
/// Shows the log view controller.
/// \param viewController The view controller from which to present the log view controller.
///
/// \param sourceFile The source file of the log.
///
+ (void) showFromViewController:(UIViewController * _Nonnull)viewController withSourceFile:(LGVFileDestination * _Nonnull)sourceFile;
@end
